...
public class AdminDashboard extends javax.swing.JFrame {
    ...
    private String adminUsername;  // optional: to show who is logged in

    // Constructor used from Login when passing username
    public AdminDashboard(String username) {
        ...
        if (adminUsername != null) {
            ...
            jLabel1.setText("Admin Dashboard (" + adminUsername + ")");
        }
    }

    // Default constructor (kept for designer / direct run)
    ...
    private void btnMealAttendenceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMealAttendenceActionPerformed
        new MealAttendencePage().setVisible(true);
        dispose();
