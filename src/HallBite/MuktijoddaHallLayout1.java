...
public class MuktijoddaHallLayout1 extends JFrame {

    public MuktijoddaHallLayout1() {
        setTitle("HallBite - 1st Floor");
        ...
        // Room numbers for 1st Floor (101-109)
        ...
        JLabel floorLabel = new JLabel("1st Floor");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new MuktijoddaHallLayout1());
    }
}
